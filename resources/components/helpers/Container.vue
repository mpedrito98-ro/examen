        ...
        <v-layout>
            ...
            >
                ...
                <v-list density="compact" nav :lines="false">
                    ...
                    <v-list-item to="/questions" prepend-icon="mdi-database-question" title="Banco de Preguntas" value="questions"></v-list-item>
                    <v-list-item to="/exam" prepend-icon="mdi-school" title="Examen" value="exam"></v-list-item>
                    <v-list-item to="/admin/colores/colores" prepend-icon="mdi-plus" title="Color" value="color"></v-list-item>
                </v-list>
            </v-navigation-drawer>
            <v-main>
                <router-view/>
